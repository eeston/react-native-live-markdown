...
function moveCursor(isFocused, alwaysMoveCursorToTheEnd, cursorPosition, target) {
  if (!isFocused) {
    return;
  }
...
function parseText(target, text, curosrPositionIndex, markdownStyle = {}, alwaysMoveCursorToTheEnd = false) {
  ...
  const rootSpan = targetElement.firstChild;
